...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		System.out.println(Arrays.toString(uarr)); //주소값만 보여줌
		for(User a : uarr) {
			System.out.printf("%s %d %d\n", a.getName(), a.getRrn(), a.getAge());
		}
		...
		while(count != 5) {
			...
			u3.setRrn(sc.nextInt());
			System.out.print("Age입력: ");
			u3.setAge(sc.nextInt());
			
			uarr2[count] = u3;
			
			System.out.printf("%s %d %d\n", uarr2[count].getName(), uarr2[count].getRrn(), uarr2[count].getAge());
			System.out.println("----------------------");
			count++;
		}
